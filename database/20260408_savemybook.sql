...
--
-- 資料表新增資料前，先清除舊資料 `admin_operation_logs`
--
...
--
-- 資料表新增資料前，先清除舊資料 `admin_permissions`
--
...
DROP TABLE IF EXISTS `bankbooks`;
...
--
-- 資料表新增資料前，先清除舊資料 `bankbooks`
--

TRUNCATE TABLE `bankbooks`;
-- --------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='書籍商品表（交易方式：智慧書櫃取書）';
...
(22, 7, '9789571069722', '把你的名字曬一曬', '張西', '三采文化', NULL, 8, 'like_new', NULL, 280.00, 1, '張西經典散文集，九成新，書況良好。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(23, 7, '9789571077383', '你已走遠，但陽光還在', '張西', '三采文化', NULL, 8, 'good', NULL, 300.00, 1, '封面有些微使用痕跡。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(24, 10, '9789571085371', '我也曾經想過一了百了', '張西', '三采文化', NULL, 8, 'like_new', NULL, 320.00, 1, '看完即收藏，保存極佳。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(25, 3, '9789571093123', '葉有慧', '張西', '三采文化', NULL, 8, 'good', NULL, 350.00, 1, '張西首部長篇小說，值得收藏。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(26, 1, '9789571066000', '皮囊', '張西', '三采文化', NULL, 8, 'fair', NULL, 200.00, 1, '內頁有少量劃記。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(27, 7, '9789571066001', '後來的您好', '張西', '三采文化', NULL, 8, 'like_new', NULL, 310.00, 1, '張西作品，書況極新。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(28, 10, '9789571066002', '朝聖', '張西', '三采文化', NULL, 8, 'good', NULL, 290.00, 1, '經典散文。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(29, 10, 'NMIXX-001', 'NMIXX - AD MARE (Limited Edition)', 'JYP', 'JYP Entertainment', NULL, 10, 'like_new', NULL, 850.00, 1, '出道單曲限量版，含全員小卡。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(30, 10, 'NMIXX-002', 'NMIXX - ENTWURF (Normal Ver.)', 'JYP', 'JYP Entertainment', NULL, 10, 'like_new', NULL, 450.00, 1, '第二張單曲專輯，無損。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(31, 10, 'NMIXX-003', 'NMIXX - expérgo (Digipack Ver.)', 'JYP', 'JYP Entertainment', NULL, 10, 'like_new', NULL, 380.00, 1, 'Sullyoon 封面版本。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(32, 10, 'NMIXX-004', 'NMIXX - A Midsummer NMIXX\'s Dream', 'JYP', 'JYP Entertainment', NULL, 10, 'like_new', NULL, 600.00, 1, '夏日限定專，內含完整寫真。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(33, 7, 'NMIXX-005', 'NMIXX - Fe3O4: BREAK (Standard Ver.)', 'JYP', 'JYP Entertainment', NULL, 10, 'like_new', NULL, 720.00, 1, '最新作品，保存良好。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(34, 7, 'NMIXX-006', 'NMIXX - Fe3O4: STICK OUT', 'JYP', 'JYP Entertainment', NULL, 10, 'like_new', NULL, 750.00, 1, '全新未拆封，含預購禮。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(35, 3, 'KPOP-B-001', 'K-POP 視覺美學：從舞台到包裝', '視覺觀察員', '藝術家出版', NULL, 3, 'good', NULL, 580.00, 1, '深度分析韓流偶像的視覺設計。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(36, 10, 'KPOP-B-002', 'NMIXX 官方應援手冊 (2024版)', 'NSWER Club', '潮流文化', NULL, 10, 'like_new', NULL, 400.00, 1, '給 NSWER 的應援攻略。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(37, 1, 'KPOP-B-003', 'JYP 娛樂的全球戰略：打造 NMIXX', '產業分析師', '商周出版', NULL, 4, 'good', NULL, 480.00, 1, '商業管理類，探討偶像產業鏈。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(38, 7, 'KPOP-B-004', '韓流流行趨勢：從二代到四代團', '音樂研究社', '音樂出版', NULL, 1, 'fair', NULL, 320.00, 1, '研究 K-POP 演變史。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(39, 3, 'KPOP-B-005', 'K-POP 舞蹈動作解析手冊', '專業舞者', '體育出版社', NULL, 9, 'good', NULL, 450.00, 1, '包含 NMIXX 的 Dice 舞步解析。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(40, 10, 'NMIXX-PH-01', 'NMIXX 官方寫真集：MIXXPEDIA', 'JYP', 'JYP Entertainment', NULL, 3, 'like_new', NULL, 1200.00, 1, '珍藏版大型寫真書。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16'),
(41, 2, 'KPOP-B-006', '韓語歌詞解析：K-POP 必備字彙', '韓語中心', '教育出版', NULL, 6, 'good', NULL, 350.00, 1, '透過 NMIXX 的歌詞學韓文。', NULL, 'on_sale', 0, 1, '2026-04-05 06:30:16', '2026-04-05 06:30:16');
...
--
-- 資料表新增資料前，先清除舊資料 `book_categories`
--
...
DROP TABLE IF EXISTS `cabinet_slots`;
...
--
-- 資料表新增資料前，先清除舊資料 `cabinet_slots`
--

TRUNCATE TABLE `cabinet_slots`;
-- --------------------------------------------------------
...
--
-- 資料表新增資料前，先清除舊資料 `content_reviews`
--

TRUNCATE TABLE `content_reviews`;
-- --------------------------------------------------------
...
--
-- 資料表新增資料前，先清除舊資料 `recommendation_logs`
--
...
--
-- 資料表新增資料前，先清除舊資料 `referral_records`
--

TRUNCATE TABLE `referral_records`;
-- --------------------------------------------------------
...
--
-- 資料表新增資料前，先清除舊資料 `refund_records`
--
...
DROP TABLE IF EXISTS `smart_cabinets`;
...
--
-- 資料表新增資料前，先清除舊資料 `smart_cabinets`
--

TRUNCATE TABLE `smart_cabinets`;
-- --------------------------------------------------------
...
--
-- 資料表新增資料前，先清除舊資料 `system_announcements`
--

TRUNCATE TABLE `system_announcements`;
-- --------------------------------------------------------
...
--
-- 資料表新增資料前，先清除舊資料 `transaction_disputes`
--
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `idx_role` (`role`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='會員資料表';
...
(11, 'binghongchen0303@gmail.com', '$2b$10$oXRZsdyQVsROE3OA8FC2JuWlas/AUTNFX9UQHq7cRkeZlpJmTJYsW', 'Gary Chen', NULL, NULL, NULL, NULL, 'undisclosed', 'admin', 1, 0, '2026-04-07 18:38:57', '2026-04-07 18:38:57');
...
--
-- 資料表新增資料前，先清除舊資料 `user_achievements`
--
...
--
-- 資料表新增資料前，先清除舊資料 `user_qr_codes`
--

TRUNCATE TABLE `user_qr_codes`;
-- --------------------------------------------------------
...
--
-- 資料表新增資料前，先清除舊資料 `wallet_transactions`
--

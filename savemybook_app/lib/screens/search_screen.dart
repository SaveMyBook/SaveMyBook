            ...
            child: Row(children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: TextField(
                    ...
                    textInputAction: TextInputAction.search, onSubmitted: _submitSearch,
                    decoration: InputDecoration(
                      hintText: '搜尋書名、作者、ISBN...', hintStyle: TextStyle(color: c.textHint, fontSize: 14),
                      border: InputBorder.none, contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                      suffixIcon: GestureDetector(onTap: () => _submitSearch(_searchController.text), child: Icon(Icons.search, color: c.iconInactive, size: 20)),
                    ),
                  ),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Text('搜尋', style: TextStyle(color: AppColors.primary, fontSize: 14, fontWeight: FontWeight.bold)),
                ),
              ),
            ]),
          ),
              ...
              return Padding(
                ...
                child: Row(children: [
                  Expanded(child: GestureDetector(
                    ...
                    child: Text(keyword, style: const TextStyle(fontSize: 16, color: AppColors.primary, fontWeight: FontWeight.w600)),
                  )),
                  GestureDetector(

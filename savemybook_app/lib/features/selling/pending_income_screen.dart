...
class _PendingIncomeScreenState extends State<PendingIncomeScreen> {
                      ...
                      builder: (context, constraints) => CustomScrollView(
                        ...
                        slivers: [
                          ...
                          if (_orders.isEmpty)
                            ...
                            SliverPadding(
                              padding: responsiveListPadding(constraints, maxWidth: Breakpoints.pageMaxWidth),
  ...
  Widget _buildTotalCard(AppColors c, double side) {
    return Padding(
      padding: EdgeInsets.fromLTRB(side, 20, side, 4),
      child: AppCard(
